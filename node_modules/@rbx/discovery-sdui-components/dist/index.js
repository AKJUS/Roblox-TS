...
const useStyles$h = makeStyles()((_theme, { color, width, iconOverrideStyles }) => ({
    iconBaseStyles: {
        display: 'inline-flex',
        alignItems: 'center',
...
const Icon = ({ iconClassName, color, width, iconOverrideStyles }) => {
    const { classes: { iconBaseStyles, iconOverride } } = useStyles$h({ color, width, iconOverrideStyles: iconOverrideStyles || {} });
...
const MaybeLinkActionWrapper = ({ containerClassName, callback, linkPath, ariaLabel, openInNewTab, tabIndex, onFocus, onFocusLost, dataTestId, children }) => {
    const { classes: { linkContainerOverride, buttonContainerOverride } } = useStyles$g({});
    if (linkPath) {
...
const useStyles$f = makeStyles()((_theme, { gap, textColor, fontStyle, containerOverrideStyles, textOverrideStyles }) => ({
    textIconRow: {
        display: 'inline-flex',
        alignItems: 'center',
        gap: `${gap}px`,
...
const TextIconRow = ({ onActivated, linkPath, text, textColor, fontStyle, gap = 0, iconClassName, iconWidth, iconColor, iconFirst = false, containerOverrides, textOverrides, iconOverrides }) => {
    ...
    const { classes: { textIconRow, textIconRowText, textOverride, iconBaseStyles } } = useStyles$f({
        gap,
        textColor,
        fontStyle,
        containerOverrideStyles,
...
const useStyles$e = makeStyles()((_theme, { itemWidth, columnGap, sideMargin, gapBetweenHeaderAndItems, scrollArrowBackgroundColor, scrollArrowBoxShadowColor, scrollArrowBaseClassName, scrollArrowPrevClassName, scrollArrowNextClassName }) => ({
...
const CollectionCarousel = ({ itemsContainerRef, items, renderItem, collectionItemSize, updateItemsPerRow, layoutOverrides, headerComponent, gapBetweenHeaderAndItems, isHorizontalScrollEnabled, scrollArrowBackgroundColor, scrollArrowBoxShadowColor, thresholdFromEnd, onReachedThresholdFromEnd, reportHorizontalScrollTelemetry }) => {
    ...
    const { classes: { collectionCarouselContainer, carouselContainer, carousel, carouselItem } } = useStyles$e({
        itemWidth,
        columnGap,
        sideMargin,
...
const useStyles$d = makeStyles()((_theme, { itemWidth, columnGap, sideMargin, gapBetweenHeaderAndItems }) => ({
...
const CollectionGrid = ({ itemsContainerRef, items, renderItem, collectionItemSize, updateItemsPerRow, layoutOverrides, headerComponent, gapBetweenHeaderAndItems }) => {
    ...
    const { classes: { collectionGridContainer, grid, gridItem } } = useStyles$d({
        itemWidth,
        columnGap,
        sideMargin,
        gapBetweenHeaderAndItems
...
const useStyles$c = makeStyles()((_theme, { iconWidth, avatarContainerBackgroundColor, avatarImageBackgroundColor, avatarBorderColor, maxZIndex }) => ({
    facepileContainer: {
        width: 'fit-content',
        display: 'flex',
        alignItems: 'center'
...
const GameTileActiveFriendsFacepile = ({ avatarThumbnails, iconWidth, avatarContainerBackgroundColor, avatarImageBackgroundColor, avatarBorderColor }) => {
    const { classes: { facepileContainer, avatarContainer } } = useStyles$c({
        iconWidth,
