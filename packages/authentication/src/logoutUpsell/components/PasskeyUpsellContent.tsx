    ...
    <React.Fragment>
      <DialogBody>
        <div className='flex flex-col'>
          <div
            className='flex items-center justify-center width-full overflow-hidden aspect-2-1'>
            <img
      ...
      <DialogFooter>
        <div className='flex flex-col gap-small width-full'>
          ...
          <Button className='width-full' variant='Utility' size='Medium' onClick={onSignOut}>
