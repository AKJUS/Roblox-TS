...
export type ThumbnailPendingTracker = Record<string, ThumbnailPendingTrackerItem>;

export type ThumbnailCompleteTracker = Record<string, ThumbnailCompleteTrackerItem>;
