...
export const getResources = (translate: TranslateFunction) =>
  ({
    ...
    Label: {
      AlternateDelayedMethod: (delaySimpleText: string) => translate('Label.AlternateDelayedMethod', { delaySimpleText }) || 
      ...
      DelayedVerification: {
        ...
        TryAgainOnTrustedDevicePrefix: (linkRef: string): React.ReactNode[] => translateHtml(
          translate as TranslateFn,
          'Label.DelayedVerification.TryAgainOnTrustedDevicePrefix',
          [{ opening: 'linkStart', closing: 'linkEnd', render: (children) => 
            <a href={linkRef} target="_blank" rel="noreferrer" className='underline'>{children}</a> }],
        ),
        TryAgainOnTrustedDeviceSuffix: (linkRef: string): React.ReactNode[] => translateHtml(
          translate as TranslateFn,
      ...
      SimpleDay: (numberOfDays: number) => translate('Label.SimpleDay', { numberOfDays }) || `${numberOfDays} day(s)`,
      SimpleHour: (numberOfHours: number) => translate('Label.SimpleHour', { numberOfHours }) || `${numberOfHours} hour(s)`,
      SimpleMinute: (numberOfMinutes: number) => translate('Label.SimpleMinute', { numberOfMinutes }) || `${numberOfMinutes} minute(s)`,
      TrustThisDevice: translate('Label.TrustThisDevice'),
      TryAgainNow: translate('Label.TryAgainNow') || 'The delay just expired! Exit this dialog and try again.',
      ...
      WeNeedYouToWait: (delaySimpleText: string) => translate('Label.WeNeedYouToWait', { delaySimpleText }) ||
