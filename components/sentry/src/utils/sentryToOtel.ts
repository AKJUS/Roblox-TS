...
export function convertSentryToOtel(event: SentryTransactionEvent): OtelTracesExport | null {
...
export function sendToOtel(endpoint: string, event: SentryTransactionEvent): void {
  try {
