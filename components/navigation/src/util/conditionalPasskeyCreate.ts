 ...
 * returns `false`.
 */
const verifyUpgradeUserOrAbort = (ctx: string, expectedUserId: string | null): boolean => {
...
export const attemptPasskeyUpgrade = async (): Promise<boolean> => {
  ...
  try {
    ...
    await finishRegistration(start.sessionId, CREDENTIAL_NICKNAME, attestationResponse, source);
