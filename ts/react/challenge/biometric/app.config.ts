...
export const BIOMETRIC_LANGUAGE_RESOURCES = [
  'Action.StartBiometricVerification',
  'Action.Verifying',
  'Action.PleaseTryAgain',
  'Action.Reload',
  'Description.BiometricVerification',
  'Description.FollowPrompt',
  'Label.BiometricVerification',
  'Label.CheckingBiometricSupport',
  'Label.FollowPrompt',
  'Label.RetryAttempt',
  'Message.Error.Default',
  'Message.Error.BiometricNotSupported',
  'Message.Error.BiometricNotEnrolled',
