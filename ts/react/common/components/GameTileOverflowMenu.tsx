...
import { TranslateFunction, queryClient } from 'react-utilities';
...
const GameTileOverflowMenu = ({
  ...
  useEffect(() => {
    if (
      ...
      fireEvent(gameTile.ReportAdDisabledDueToMissingEncryptedAdTrackingData);
  ...
  }, [encryptedAdTrackingData, universeId]);
